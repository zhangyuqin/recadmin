...
$(document).ready(function() {
    ...
    var m = new Metronome( {url: metronomeServer, datapoints: 250 });
...
/*
    ...
    else if (components[0]=="unbound") {
	    configs=[ { 
		items: [ 
		    //{name: "unbound."+components[1]+".main.servfail-responses", legend: "Servfail/s"},
		    {name: "unbound."+components[1]+".main.total.num.queries", legend: "Queries/s"},
		    {name: "unbound."+components[1]+".main.num.answer.rcode.SERVFAIL", legend: "SERVFAIL/s"},
		    {name: "unbound."+components[1]+".main.num.answer.rcode.NXDOMAIN", legend: "NXDOMAIN/s"},
    ...
    else if (components[0]=="rxbytes") {
	    configs=[ { 
		items: [ 
		    //{name: "unbound."+components[1]+".main.servfail-responses", legend: "Servfail/s"},
		    {name: "rxbytes", legend: "rxbytes/s"},
		    //{name: "dnsdist."+components[1]+".main.responses", legend: "Responses/s"}
